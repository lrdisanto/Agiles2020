...
class ProfController {
    ...
    getprofID(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('SELECT * FROM profesor WHERE mail=?', [email], function (err, data) {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const prof = yield database_1.default.query('SELECT * FROM profesor WHERE idprofesor= ?', [id]);
            console.log(id);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE profesor set ? WHERE idprofesor = ?', [req.body, id]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM profesor WHERE idprofesor = ?', [id]);
        });
    }
}
